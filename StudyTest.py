...
class PopoStudyClass :
    ...
    def StudyResult(self):
        ...
        try:
            if(neck/maX > 0.25) :   #CONSIDERING 25% CONFIDENCE TO BE SUFFICIENT TO CLASSIFY THIS POSTURE
                print('Neck estimation ...POSTURE : Studying')
            else:
                 pass
            if(limb/maX > 0.40):    #CONSIDERING 40% CONFIDENCE
                print('Limb estimation ...POSTURE : Studying')
            else:
                pass
        except ZeroDivisionError:
            pass
