...
#-> CAPABLE OF IMPORTING THE "SleepTest.py" AND ESTIMATING STUDYING POSTURE
import argparse
import logging
import time
#POPO EDIT
...
if __name__ == '__main__':
    ...
    while True: 
        ...
        while time.time() < t_end:
            ...
            ##print("PARTS avl : ",toPlotDict)
            #EDITING CSV FILES AND STORING RECORDED DATA FOR WALK ESTIMATION
            ...
            PopoStudyClass.StudyAnalyze(s, toPlotDict)
